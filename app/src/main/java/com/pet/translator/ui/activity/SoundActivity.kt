...
import com.pet.translator.databinding.ActivitySoundDetailBinding
...
class SoundActivity : BaseActivity() {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        val item = if (isDog) {
            com.pet.translator.AppConst.dogSoundList(this)[index]
        } else {
            com.pet.translator.AppConst.catSoundList(this)[index]
        }
