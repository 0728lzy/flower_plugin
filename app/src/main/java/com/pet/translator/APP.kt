...
import com.pet.translator.utils.dj.TimerInitSDK
...
class APP : Application() {
    ...
    override fun onCreate() {
        ...
        NetConfig.initialize("", this) {
            ...
            setDebug(com.pet.translator.BuildConfig.DEBUG)
            ...
            addInterceptor(LogRecordInterceptor(com.pet.translator.BuildConfig.DEBUG))
        }
        DialogX.init(this)
