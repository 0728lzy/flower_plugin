...
import com.catcsyun.liantadog.csj.PrintUtil
import com.catcsyun.liantadog.csj.UISimpleUtils
import com.catcsyun.liantadog.utils.dj.GetHttpDataUtil.reportAdReport
...
object AdFeedSimpleInitThreeUtils {

    private var mAdUnitId =  AppConst.FEEDSIMPLE_ID_THREE
...
//            flContent.removeAllViews()
    ...
    fun isReady(): Boolean {
        if (mTTFeedAd != null && mTTFeedAd?.mediationManager != null && mTTFeedAd?.mediationManager!!.isReady&&!mIsLoadAndShow) {//已经获取到广告且广告未被展示
            return true
        }
        return false
    }
