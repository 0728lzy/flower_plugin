...
import com.catcsyun.liantadog.databinding.ActivitySoundDetailBinding
import com.catcsyun.liantadog.ext.dp2px
import com.catcsyun.liantadog.ext.thrillClickListener

import java.math.BigDecimal
import java.math.RoundingMode

class KLTGSoundActivity : BaseActivity() {

    companion object {
        fun show(context: Context, isDog: Boolean, index: Int) {
            context.startActivity(Intent(context, KLTGSoundActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@KLTGSoundActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@KLTGSoundActivity,"信息",binding.feedContainerActivitySound)
        ...
        val item = if (isDog) {
            com.catcsyun.liantadog.AppConst.dogSoundList(this)[index]
        } else {
            com.catcsyun.liantadog.AppConst.catSoundList(this)[index]
        }
