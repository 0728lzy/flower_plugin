...
import com.catcsyun.liantadog.databinding.ActivityAboutBinding
...
class KLTGAboutActivity : BaseActivity() {

    companion object {
        fun forward(context: BaseActivity) {
            val intent = Intent(context, KLTGAboutActivity::class.java)
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@KLTGAboutActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@KLTGAboutActivity,"",binding.feedContainerActivityAbout)
        ...
        mineLinearLayout.outlineProvider = object : ViewOutlineProvider() {
            override fun getOutline(view: View, outline: Outline?) {
                outline?.setRoundRect(
                    ...
                    view.width,
                    view.height,
                    ScreenUtils.dip2px(15, this@KLTGAboutActivity).toFloat()
                )
            }
        }
        ...
        feedbackLinearLayout.thrillClickListener {
            KLTGContactCustomerServiceActivity.show(this@KLTGAboutActivity)
        }
    ...
    private fun showInputPasswordDialog() {
        ...
        val customPopup =
            QNInputPasswordDialogPopup(this@KLTGAboutActivity)
        ...
        inputPopupView = XPopup.Builder(this@KLTGAboutActivity)
