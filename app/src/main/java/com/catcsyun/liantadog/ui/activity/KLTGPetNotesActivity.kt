...
import com.catcsyun.liantadog.databinding.ActivityPetNotesBinding
import com.catcsyun.liantadog.model.Pet
import com.catcsyun.liantadog.model.PetNote
import com.catcsyun.liantadog.ui.adapter.PetNotesAdapter
import com.catcsyun.liantadog.ui.dialog.AddEditNoteDialog
import com.gyf.immersionbar.ImmersionBar
import com.lxj.xpopup.XPopup
import com.lxj.xpopup.core.BasePopupView


class KLTGPetNotesActivity : BaseActivity() {

    companion object {
        fun forward(context: Context) {
            val intent = Intent(context, KLTGPetNotesActivity::class.java)
    ...
    private fun initViews() {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@KLTGPetNotesActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@KLTGPetNotesActivity,"信息",binding.feedContainer)
    }
...
//                    showAddEditNoteDialog(note)
        ...
        binding.rvNotes.apply {
            layoutManager = LinearLayoutManager(this@KLTGPetNotesActivity)
            ...
            onNoteActionListener = object : AddEditNoteDialog.OnNoteActionListener {
                override fun onNoteSaved(note: PetNote) {
                    ...
                    if (note.save()) {
                        ...
                        ZYMAllAdsUtils.showAdCpTurnTab(this@KLTGPetNotesActivity,"CP")
                        Toast.makeText(this@KLTGPetNotesActivity, message, Toast.LENGTH_SHORT).show()
                    } else {
                        Toast.makeText(this@KLTGPetNotesActivity, "保存失败", Toast.LENGTH_SHORT).show()
                    }
                }
            }
        )

        inputPopupView = XPopup.Builder(this@KLTGPetNotesActivity)
