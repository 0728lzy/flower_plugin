...
import com.catcsyun.liantadog.databinding.FragmentPetManagementBinding
import com.catcsyun.liantadog.event.SimpleEvent
import com.catcsyun.liantadog.model.Pet
import com.catcsyun.liantadog.ui.activity.KLTGPetBathActivity
import com.catcsyun.liantadog.ui.activity.KLTGPetNotesActivity
import com.catcsyun.liantadog.ui.activity.KLTGPetPhotosActivity
import com.catcsyun.liantadog.ui.adapter.PetAdapter
import com.catcsyun.liantadog.ui.dialog.AddPetDialog
import com.catcsyun.liantadog.utils.ToastUtils
...
class HDSPetManagementFragment : RootFragment(R.layout.fragment_pet_management) {
    ...
    private fun initViews() {
        ...
        binding.layoutPetAlbum.setOnClickListener {
            ...
            KLTGPetPhotosActivity.forward(requireContext())
        ...
        binding.layoutPetNotes.setOnClickListener {
            ...
            // 如果只有一只宠物，直接跳转到该宠物的相册
            KLTGPetNotesActivity.forward(requireContext())
        }
        ...
        binding.layoutBathRecord.setOnClickListener {
            ...
            // 如果只有一只宠物，直接跳转到该宠物的相册
            KLTGPetBathActivity.forward(requireContext())
        }
    }
    ...
    private fun showPetSelectionDialog() {
        ...
        XPopup.Builder(requireContext())
            .asBottomList("选择宠物", petNames) { position, text ->
                com.catcsyun.liantadog.ui.activity.KLTGPetPhotosActivity.forward(requireContext())
            }
            .show()
    }
