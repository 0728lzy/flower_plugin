...
import com.catcsyun.liantadog.databinding.ActivityOverviewCallBinding
...
class KLTGVideoActivity : BaseActivity() {

    companion object {
        fun show(context: Context, index: Int) {
            context.startActivity(Intent(context, KLTGVideoActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@KLTGVideoActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@KLTGVideoActivity,"信息",binding.feedContainer)
    ...
    private fun goCall() {
        stopTime()
        reset()
        KLTGCallActivity.show(this, index)
    }
