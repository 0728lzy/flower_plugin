...
import com.catcsyun.liantadog.databinding.ActivityPetPhotosBinding
import com.catcsyun.liantadog.model.Pet
import com.catcsyun.liantadog.model.PetPhoto
import com.catcsyun.liantadog.ui.adapter.PetPhotosAdapter
import com.catcsyun.liantadog.ui.dialog.UploadPhotoDialog
...
import com.catcsyun.liantadog.ui.dialog.DeletePhotoDialog


class KLTGPetPhotosActivity : BaseActivity() {

    companion object {
        fun forward(context: Context) {
            val intent = Intent(context, KLTGPetPhotosActivity::class.java)
    ...
    private fun initViews() {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@KLTGPetPhotosActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@KLTGPetPhotosActivity,"信息",binding.feedContainer)
    }
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvPhotos.apply {
            layoutManager = GridLayoutManager(this@KLTGPetPhotosActivity, 2)
    ...
    private fun showUploadPhotoDialog() {
        ...
        inputPopupView = XPopup.Builder(this@KLTGPetPhotosActivity)
    ...
    private fun deletePopupDialog(photo: PetPhoto) {
        ...
        deletePopupView = XPopup.Builder(this@KLTGPetPhotosActivity)
            .autoOpenSoftInput(false)
            .autoDismiss(false)
            .dismissOnBackPressed(false)
            .dismissOnTouchOutside(false)
