...
import com.catcsyun.liantadog.databinding.FragmentPetVideoBinding
import com.catcsyun.liantadog.databinding.ItemPetVideoBinding
...
import com.catcsyun.liantadog.ui.activity.KLTGVideoActivity
...
class HDSPetVideoFragment : RootFragment(R.layout.fragment_pet_video) {
            ...
            onBind {
                getBinding<ItemPetVideoBinding>().apply {
                    ...
                    root.thrillClickListener {
                        ...
                        KLTGVideoActivity.show(requireContext(), index)
                    }
                }
            }
        }
