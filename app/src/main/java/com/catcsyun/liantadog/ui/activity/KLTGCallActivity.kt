...
import com.catcsyun.liantadog.databinding.ActivityIncomingCallBinding
...
class KLTGCallActivity : BaseActivity() {


    companion object {
        fun show(context: Context, index: Int) {
            context.startActivity(Intent(context, KLTGCallActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ivAnswerIncoming.thrillClickListener {
            PermissionUtils.tryToDoSomethingWithCheckPermissionAndCode(
                ...
                answer()
                com.catcsyun.liantadog.utils.VibrateTool.vibrateStop()
            }
        }
        binding.rlIncomingCall.isVisible = true
        binding.rlAnswerCall.isVisible = false
        com.catcsyun.liantadog.utils.VibrateTool.vibrateComplicated(this, longArrayOf(500L, 1000L), 0)
    }
    ...
    private fun playVideo() {
        ...
        val dataSourceFactory = DataSource.Factory { AssetDataSource(this@KLTGCallActivity) }
