...
import com.catcsyun.liantadog.databinding.ActivityPetBathBinding
import com.catcsyun.liantadog.model.Pet
import com.catcsyun.liantadog.model.PetBathRecord
import com.catcsyun.liantadog.ui.adapter.PetBathRecordAdapter
import com.catcsyun.liantadog.ui.dialog.AddEditBathRecordDialog
 ...
 * 显示和管理宠物的洗澡记录
 */
class KLTGPetBathActivity : AppCompatActivity() {
    ...
    companion object {
        fun forward(context: Context) {
            val intent = Intent(context, KLTGPetBathActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@KLTGPetBathActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@KLTGPetBathActivity,"信息",binding.feedContainer)
    ...
    private fun showAddEditDialog(record: PetBathRecord?) {
        ...
        inputPopupView = XPopup.Builder(this@KLTGPetBathActivity)
