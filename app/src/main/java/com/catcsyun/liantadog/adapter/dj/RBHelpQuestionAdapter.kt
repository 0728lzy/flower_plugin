package com.catcsyun.liantadog.adapter.dj
...
import com.catcsyun.liantadog.adapter.dj.base.BaseAdapter
import com.catcsyun.liantadog.adapter.dj.base.BaseViewHolder
import com.catcsyun.liantadog.bean.dj.KLTGHelpQuestionBean

class RBHelpQuestionAdapter(
    context: Context,
    id: Int,
    data: List<KLTGHelpQuestionBean>
) :
    BaseAdapter<KLTGHelpQuestionBean>(context, id, data) {
    @SuppressLint("SuspiciousIndentation")
    override fun bindView(holder: BaseViewHolder, data: KLTGHelpQuestionBean) {
