...
//开通会员
public class KLTGOpenMemberBean implements Serializable {
    ...
    private KLTGOpenMemberBean renewGoodsVO;


    public KLTGOpenMemberBean getRenewGoodsVO() {
        return renewGoodsVO;
    }

    public void setRenewGoodsVO(KLTGOpenMemberBean renewGoodsVO) {
