...
import com.qingchu.wangmiao.databinding.ActivityPetNotesBinding
import com.qingchu.wangmiao.model.Pet
import com.qingchu.wangmiao.model.PetNote
import com.qingchu.wangmiao.ui.adapter.PetNotesAdapter
import com.qingchu.wangmiao.ui.dialog.AddEditNoteDialog
...
class PetNotesActivity : BaseActivity() {
    ...
    companion object {
        fun forward(context: Context) {
            val intent = Intent(context, PetNotesActivity::class.java)
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvNotes.apply {
            layoutManager = LinearLayoutManager(this@PetNotesActivity)
