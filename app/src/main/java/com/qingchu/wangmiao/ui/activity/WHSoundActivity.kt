...
import com.qingchu.wangmiao.databinding.ActivitySoundDetailBinding
import com.qingchu.wangmiao.ext.dp2px
...
class WHSoundActivity : BaseActivity() {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        val item = if (isDog) {
            com.qingchu.wangmiao.AppConst.dogSoundList(this)[index]
        } else {
            com.qingchu.wangmiao.AppConst.catSoundList(this)[index]
        }
