...
import com.qingchu.wangmiao.databinding.FragmentIndex1Binding
...
class WHIndex1Fragment : RootFragment(R.layout.fragment_index_1) {
    ...
    private fun dog() {
        ...
        binding.rvList.bindingAdapter.models =
            com.qingchu.wangmiao.AppConst.dogSoundList(requireContext()).shuffled()
    }

    private fun cat() {
        type = 2
        binding.rvList.bindingAdapter.models =
            com.qingchu.wangmiao.AppConst.catSoundList(requireContext()).shuffled()
    }
}