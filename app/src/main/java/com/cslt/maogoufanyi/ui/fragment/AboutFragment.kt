...
import com.cslt.maogoufanyi.ui.activity.QCContactCustomerServiceActivity
...
class AboutFragment : RootFragment(R.layout.fragment_about) {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        feedbackLinearLayout.thrillClickListener {
            QCContactCustomerServiceActivity.show(requireActivity() as com.cslt.maogoufanyi.base.dj.BaseActivity)
        }
