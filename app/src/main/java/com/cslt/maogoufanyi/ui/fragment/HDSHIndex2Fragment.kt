...
import com.cslt.maogoufanyi.databinding.FragmentIndex4Binding
import com.cslt.maogoufanyi.databinding.Item4Binding
import com.cslt.maogoufanyi.entity.Index4Entity
import com.cslt.maogoufanyi.ext.getBinding
import com.cslt.maogoufanyi.ext.thrillClickListener
import com.cslt.maogoufanyi.ui.activity.HDSDetailActivity
...
class HDSHIndex2Fragment : RootFragment(R.layout.fragment_index_4) {
            ...
            onBind {
                getBinding<Item4Binding>().apply {
                    ...
                    root.thrillClickListener {
                        ...
                        HDSDetailActivity.show(requireContext(), index)
                    }
                }
            }
        }
