...
class HDSSoundActivity : BaseActivity() {

    companion object {
        fun show(context: Context, isDog: Boolean, index: Int) {
            context.startActivity(Intent(context, HDSSoundActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        val item = if (isDog) {
            com.cslt.maogoufanyi.AppConst.dogSoundList(this)[index]
        } else {
            com.cslt.maogoufanyi.AppConst.catSoundList(this)[index]
        }
