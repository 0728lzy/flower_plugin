...
class HDSContactCustomerServiceActivity : BaseActivity(){
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        mAdapter.setItemClickListener(object : ItemClickListener<HDSHelpQuestionBean> {
            override fun click(position: Int, data: HDSHelpQuestionBean) {
...
//    }  
    ...
    companion object {
        fun show(context: Context?) {
            IntentUtil.redirect(context, HDSContactCustomerServiceActivity::class.java, false, null)
        }
    }
    ...
    fun getCommonConfig(){
        GetHttpDataUtil.getCommonConfig(object : GetHttpDataUtil.OnSuccessAndFaultListener{
            override fun onSuccess(t: Any) {
                commonConfigs = t as ArrayList<HDSCommonConfigBean>
                setData()
            }
    ...
    fun getIssuesList(){
        GetHttpDataUtil.getIssuesList(object : GetHttpDataUtil.OnSuccessAndFaultListener{
            override fun onSuccess(t: Any) {
                ...
                questionList.addAll(t as ArrayList<HDSHelpQuestionBean>)
