...
import com.cslt.maogoufanyi.databinding.FragmentIndex1Binding
...
class HDSHIndex1Fragment : RootFragment(R.layout.fragment_index_1) {
            ...
            onBind {
                getBinding<ItemDogBinding>().apply {
                    ...
                    root.thrillClickListener {
                        HDSSoundActivity.show(requireContext(), type == 1, modelPosition)
                    }
                }
            }
        }
    ...
    private fun dog() {
        ...
        binding.rvList.bindingAdapter.models =
            com.cslt.maogoufanyi.AppConst.dogSoundList(requireContext()).shuffled()
    }

    private fun cat() {
        type = 2
        binding.rvList.bindingAdapter.models =
            com.cslt.maogoufanyi.AppConst.catSoundList(requireContext()).shuffled()
    }
}