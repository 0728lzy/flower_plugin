...
import com.cslt.maogoufanyi.databinding.ActivityIncomingCallBinding
import com.cslt.maogoufanyi.ext.countDown
...
class HDSCallActivity : BaseActivity() {


    companion object {
        fun show(context: Context, index: Int) {
            context.startActivity(Intent(context, HDSCallActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ivAnswerIncoming.thrillClickListener {
            PermissionUtils.tryToDoSomethingWithCheckPermissionAndCode(
                ...
                answer()
                com.cslt.maogoufanyi.utils.VibrateTool.vibrateStop()
            }
        }
        binding.rlIncomingCall.isVisible = true
        binding.rlAnswerCall.isVisible = false
        com.cslt.maogoufanyi.utils.VibrateTool.vibrateComplicated(this, longArrayOf(500L, 1000L), 0)
    }
    ...
    private fun playVideo() {
        ...
        val dataSourceFactory = DataSource.Factory { AssetDataSource(this@HDSCallActivity) }
