...
import com.cslt.maogoufanyi.ui.activity.PetBathActivity
import com.cslt.maogoufanyi.ui.activity.PetNotesActivity
import com.cslt.maogoufanyi.ui.activity.PetPhotosActivity
    ...
    private fun showPetSelectionDialog() {
        ...
        XPopup.Builder(requireContext())
            .asBottomList("选择宠物", petNames) { position, text ->
                com.cslt.maogoufanyi.ui.activity.PetPhotosActivity.forward(requireContext())
            }
            .show()
    }
