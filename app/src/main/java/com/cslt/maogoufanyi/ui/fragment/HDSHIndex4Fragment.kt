...
import com.cslt.maogoufanyi.databinding.FragmentIndex5Binding
import com.cslt.maogoufanyi.databinding.Item5Binding
...
import com.cslt.maogoufanyi.ui.activity.HDSVideoActivity
...
class HDSHIndex4Fragment : RootFragment(R.layout.fragment_index_5) {
            ...
            onBind {
                getBinding<Item5Binding>().apply {
                    ...
                    root.thrillClickListener {
                        ...
                        HDSVideoActivity.show(requireContext(), index)
                    }
                }
            }
        }
