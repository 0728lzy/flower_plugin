...
import com.cslt.maogoufanyi.databinding.FragmentIndex3Binding
import com.cslt.maogoufanyi.entity.Index3Entity
...
class HDSHIndex3Fragment : RootFragment(R.layout.fragment_index_3) {
        ...
        binding.btnRecord.thrillClickListener {
            PermissionUtils.tryToDoSomethingWithCheckPermissionAndCode(
                ...
                if (binding.lottie.isAnimating) {
                    ...
                    if (record == null) {
                        record = com.cslt.maogoufanyi.utils.AudioRecordUtil()
