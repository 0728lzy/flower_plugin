...
class HDSPetPhotosActivity : BaseActivity() {
    ...
    companion object {
        fun forward(context: Context) {
            val intent = Intent(context, HDSPetPhotosActivity::class.java)
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvPhotos.apply {
            layoutManager = GridLayoutManager(this@HDSPetPhotosActivity, 2)
    ...
    private fun showUploadPhotoDialog() {
        ...
        inputPopupView = XPopup.Builder(this@HDSPetPhotosActivity)
