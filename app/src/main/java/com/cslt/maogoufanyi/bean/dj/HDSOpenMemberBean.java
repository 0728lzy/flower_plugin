...
//开通会员
public class HDSOpenMemberBean implements Serializable {
    ...
    private HDSOpenMemberBean renewGoodsVO;


    public HDSOpenMemberBean getRenewGoodsVO() {
        return renewGoodsVO;
    }

    public void setRenewGoodsVO(HDSOpenMemberBean renewGoodsVO) {
