...
//开通会员
public class CAOpenMemberBean implements Serializable {
    ...
    private CAOpenMemberBean renewGoodsVO;


    public CAOpenMemberBean getRenewGoodsVO() {
        return renewGoodsVO;
    }

    public void setRenewGoodsVO(CAOpenMemberBean renewGoodsVO) {
