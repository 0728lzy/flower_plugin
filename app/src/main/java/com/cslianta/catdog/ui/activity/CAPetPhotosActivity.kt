...
import com.cslianta.catdog.databinding.ActivityPetPhotosBinding
import com.cslianta.catdog.model.Pet
import com.cslianta.catdog.model.PetPhoto
import com.cslianta.catdog.ui.adapter.PetPhotosAdapter
import com.cslianta.catdog.ui.dialog.UploadPhotoDialog
...
import com.cslianta.catdog.ui.dialog.DeletePhotoDialog


class CAPetPhotosActivity : BaseActivity() {

    companion object {
        fun forward(context: Context) {
            val intent = Intent(context, CAPetPhotosActivity::class.java)
    ...
    private fun initViews() {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@CAPetPhotosActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@CAPetPhotosActivity,"信息",binding.feedContainer)
    }
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvPhotos.apply {
            layoutManager = GridLayoutManager(this@CAPetPhotosActivity, 2)
    ...
    private fun showUploadPhotoDialog() {
        ...
        inputPopupView = XPopup.Builder(this@CAPetPhotosActivity)
    ...
    private fun deletePopupDialog(photo: PetPhoto) {
        ...
        deletePopupView = XPopup.Builder(this@CAPetPhotosActivity)
            .autoOpenSoftInput(false)
            .autoDismiss(false)
            .dismissOnBackPressed(false)
            .dismissOnTouchOutside(false)
