...
import com.cslianta.catdog.databinding.ActivityDetailBinding
import com.cslianta.catdog.ext.getBinding
import com.cslianta.catdog.ext.thrillClickListener


class CADetailActivity : BaseActivity() {

    companion object {
        fun show(context: Context, index: Int) {
            context.startActivity(Intent(context, CADetailActivity::class.java).apply { putExtra("index", index) })
        }
    }
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@CADetailActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@CADetailActivity,"信息",binding.feedContainerActivityDetail)
