...
import com.cslianta.catdog.databinding.ActivityPermissionBinding
import com.cslianta.catdog.ext.thrillClickListener

class CAPermissionActivity : BaseActivity() {

    companion object {
        fun forward(context: Context) {
            context.startActivity(Intent(context, CAPermissionActivity::class.java))
        }
    }
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnContinue2.thrillClickListener {
            ...
            MainActivity.forward(this@CAPermissionActivity)
        }
    }
