...
import com.cslianta.catdog.databinding.FragmentPetManagementBinding
import com.cslianta.catdog.event.SimpleEvent
import com.cslianta.catdog.model.Pet
import com.cslianta.catdog.ui.activity.CAPetBathActivity
import com.cslianta.catdog.ui.activity.CAPetNotesActivity
import com.cslianta.catdog.ui.activity.CAPetPhotosActivity
import com.cslianta.catdog.ui.adapter.PetAdapter
import com.cslianta.catdog.ui.dialog.AddPetDialog
...
class HDSPetManagementFragment : RootFragment(R.layout.fragment_pet_management) {
    ...
    private fun initViews() {
        ...
        binding.layoutPetAlbum.setOnClickListener {
            ...
            CAPetPhotosActivity.forward(requireContext())
        ...
        binding.layoutPetNotes.setOnClickListener {
            ...
            // 如果只有一只宠物，直接跳转到该宠物的相册
            CAPetNotesActivity.forward(requireContext())
        }
        ...
        binding.layoutBathRecord.setOnClickListener {
            ...
            // 如果只有一只宠物，直接跳转到该宠物的相册
            CAPetBathActivity.forward(requireContext())
        }
    }
    ...
    private fun showPetSelectionDialog() {
        ...
        XPopup.Builder(requireContext())
            .asBottomList("选择宠物", petNames) { position, text ->
                com.cslianta.catdog.ui.activity.CAPetPhotosActivity.forward(requireContext())
            }
            .show()
    }
