...
import com.cslianta.catdog.databinding.ActivitySoundDetailBinding
import com.cslianta.catdog.ext.dp2px
import com.cslianta.catdog.ext.thrillClickListener

import java.math.BigDecimal
import java.math.RoundingMode

class CASoundActivity : BaseActivity() {

    companion object {
        fun show(context: Context, isDog: Boolean, index: Int) {
            context.startActivity(Intent(context, CASoundActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@CASoundActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@CASoundActivity,"信息",binding.feedContainerActivitySound)
        ...
        val item = if (isDog) {
            com.cslianta.catdog.AppConst.dogSoundList(this)[index]
        } else {
            com.cslianta.catdog.AppConst.catSoundList(this)[index]
        }
