...
import com.cslianta.catdog.databinding.ActivityOverviewCallBinding
...
class CAVideoActivity : BaseActivity() {

    companion object {
        fun show(context: Context, index: Int) {
            context.startActivity(Intent(context, CAVideoActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@CAVideoActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@CAVideoActivity,"信息",binding.feedContainer)
    ...
    private fun goCall() {
        stopTime()
        reset()
        CACallActivity.show(this, index)
    }
