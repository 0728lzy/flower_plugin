...
import com.cslianta.catdog.adapter.dj.utils.GridRec
...
import com.cslianta.catdog.utils.dj.IntentUtil
...
class CAContactCustomerServiceActivity : BaseActivity(){




    private var questionList = ArrayList<CAHelpQuestionBean>()
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        mAdapter.setItemClickListener(object : ItemClickListener<CAHelpQuestionBean> {
            override fun click(position: Int, data: CAHelpQuestionBean) {
...
//    }  
    ...
    companion object {
        fun show(context: Context?) {
            IntentUtil.redirect(context, CAContactCustomerServiceActivity::class.java, false, null)
        }
    }
    ...
    var commonConfigs = ArrayList<CACommonConfigBean>()

    //获取Vip通用配置  
    fun getCommonConfig(){
        GetHttpDataUtil.getCommonConfig(object : GetHttpDataUtil.OnSuccessAndFaultListener{
            override fun onSuccess(t: Any) {
                commonConfigs = t as ArrayList<CACommonConfigBean>
                setData()
            }
    ...
    fun getIssuesList(){
        GetHttpDataUtil.getIssuesList(object : GetHttpDataUtil.OnSuccessAndFaultListener{
            override fun onSuccess(t: Any) {
                ...
                questionList.addAll(t as ArrayList<CAHelpQuestionBean>)
