...
import com.cslianta.catdog.databinding.ActivityPetBathBinding
import com.cslianta.catdog.model.Pet
import com.cslianta.catdog.model.PetBathRecord
import com.cslianta.catdog.ui.adapter.PetBathRecordAdapter
import com.cslianta.catdog.ui.dialog.AddEditBathRecordDialog
 ...
 * 显示和管理宠物的洗澡记录
 */
class CAPetBathActivity : AppCompatActivity() {
    ...
    companion object {
        fun forward(context: Context) {
            val intent = Intent(context, CAPetBathActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@CAPetBathActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@CAPetBathActivity,"信息",binding.feedContainer)
    ...
    private fun showAddEditDialog(record: PetBathRecord?) {
        ...
        inputPopupView = XPopup.Builder(this@CAPetBathActivity)
