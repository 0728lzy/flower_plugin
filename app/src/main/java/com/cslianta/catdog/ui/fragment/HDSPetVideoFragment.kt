...
import com.cslianta.catdog.databinding.FragmentPetVideoBinding
import com.cslianta.catdog.databinding.ItemPetVideoBinding
...
import com.cslianta.catdog.ui.activity.CAVideoActivity
            ...
            onBind {
                getBinding<ItemPetVideoBinding>().apply {
                    ...
                    root.thrillClickListener {
                        ...
                        CAVideoActivity.show(requireContext(), index)
                    }
                }
            }
        }
