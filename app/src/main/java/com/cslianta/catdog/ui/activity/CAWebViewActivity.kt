...
import com.cslianta.catdog.databinding.ActivitySimpleBrowserBinding
import com.cslianta.catdog.ext.dj.thrillClickListener
...
import com.cslianta.catdog.widget.dj.NewWebView
import com.yl.adsdk.YlLib


class CAWebViewActivity : BaseActivity() {
    companion object {

        fun forward(context: Context, title: String, url: String) {
            context.startActivity(Intent(context, CAWebViewActivity::class.java).apply {
                putExtra("url", url)
