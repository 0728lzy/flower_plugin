...
import com.cslianta.catdog.databinding.ActivityPetNotesBinding
import com.cslianta.catdog.model.Pet
import com.cslianta.catdog.model.PetNote
import com.cslianta.catdog.ui.adapter.PetNotesAdapter
import com.cslianta.catdog.ui.dialog.AddEditNoteDialog
import com.gyf.immersionbar.ImmersionBar
import com.lxj.xpopup.XPopup
import com.lxj.xpopup.core.BasePopupView


class CAPetNotesActivity : BaseActivity() {

    companion object {
        fun forward(context: Context) {
            val intent = Intent(context, CAPetNotesActivity::class.java)
    ...
    private fun initViews() {
        ...
        ZYMAllAdsUtils.loadSimpleAll(this@CAPetNotesActivity,"信息",binding.feedContainer)
    }
...
//                    showAddEditNoteDialog(note)
        ...
        binding.rvNotes.apply {
            layoutManager = LinearLayoutManager(this@CAPetNotesActivity)
            ...
            onNoteActionListener = object : AddEditNoteDialog.OnNoteActionListener {
                override fun onNoteSaved(note: PetNote) {
                    ...
                    if (note.save()) {
                        ...
                        Toast.makeText(this@CAPetNotesActivity, "保存失败", Toast.LENGTH_SHORT).show()
                    }
                }
            }
        )

        inputPopupView = XPopup.Builder(this@CAPetNotesActivity)
