...
import com.cslianta.catdog.ui.activity.LauncherActivity
import com.cslianta.catdog.utils.dj.CountdownTimeTask
import com.cslianta.catdog.utils.dj.GetHttpDataUtil
import com.cslianta.catdog.utils.dj.SPUtils
import com.cslianta.catdog.utils.dj.TimeUtil
...
//            }
    ...
    override fun onCreate() {
        ...
        NetConfig.initialize("", this) {
            ...
            setDebug(com.cslianta.catdog.BuildConfig.DEBUG)
            ...
            addInterceptor(LogRecordInterceptor(com.cslianta.catdog.BuildConfig.DEBUG))
        }
        DialogX.init(this)
