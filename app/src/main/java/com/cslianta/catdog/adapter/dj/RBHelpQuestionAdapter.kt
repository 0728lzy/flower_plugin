package com.cslianta.catdog.adapter.dj
...
import com.cslianta.catdog.adapter.dj.base.BaseAdapter
import com.cslianta.catdog.adapter.dj.base.BaseViewHolder
import com.cslianta.catdog.bean.dj.CAHelpQuestionBean

class RBHelpQuestionAdapter(
    context: Context,
    id: Int,
    data: List<CAHelpQuestionBean>
) :
    BaseAdapter<CAHelpQuestionBean>(context, id, data) {
    @SuppressLint("SuspiciousIndentation")
    override fun bindView(holder: BaseViewHolder, data: CAHelpQuestionBean) {
