...
//开通会员
public class WCOpenMemberBean implements Serializable {
    ...
    private WCOpenMemberBean renewGoodsVO;


    public WCOpenMemberBean getRenewGoodsVO() {
        return renewGoodsVO;
    }

    public void setRenewGoodsVO(WCOpenMemberBean renewGoodsVO) {
