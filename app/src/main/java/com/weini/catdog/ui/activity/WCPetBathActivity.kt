...
import com.weini.catdog.databinding.ActivityPetBathBinding
import com.weini.catdog.model.Pet
import com.weini.catdog.model.PetBathRecord
import com.weini.catdog.ui.adapter.PetBathRecordAdapter
import com.weini.catdog.ui.dialog.AddEditBathRecordDialog
 ...
 * 显示和管理宠物的洗澡记录
 */
class WCPetBathActivity : AppCompatActivity() {
    ...
    companion object {
        fun forward(context: Context) {
            val intent = Intent(context, WCPetBathActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@WCPetBathActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@WCPetBathActivity,"信息",binding.feedContainer)
    ...
    private fun showAddEditDialog(record: PetBathRecord?) {
        ...
        inputPopupView = XPopup.Builder(this@WCPetBathActivity)
