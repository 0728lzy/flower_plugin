...
import com.weini.catdog.databinding.ActivitySoundDetailBinding
import com.weini.catdog.ext.dp2px
import com.weini.catdog.ext.thrillClickListener

import java.math.BigDecimal
import java.math.RoundingMode

class WCSoundActivity : BaseActivity() {

    companion object {
        fun show(context: Context, isDog: Boolean, index: Int) {
            context.startActivity(Intent(context, WCSoundActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@WCSoundActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@WCSoundActivity,"信息",binding.feedContainerActivitySound)
        ...
        val item = if (isDog) {
            com.weini.catdog.AppConst.dogSoundList(this)[index]
        } else {
            com.weini.catdog.AppConst.catSoundList(this)[index]
        }
