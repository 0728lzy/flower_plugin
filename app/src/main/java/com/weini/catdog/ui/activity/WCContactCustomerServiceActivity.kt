...
import com.weini.catdog.adapter.dj.RBHelpQuestionAdapter
import com.weini.catdog.adapter.dj.base.ItemClickListener
import com.weini.catdog.adapter.dj.utils.GridRec
...
import com.weini.catdog.utils.dj.IntentUtil
...
class WCContactCustomerServiceActivity : BaseActivity(){




    private var questionList = ArrayList<WCHelpQuestionBean>()
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        mAdapter.setItemClickListener(object : ItemClickListener<WCHelpQuestionBean> {
            override fun click(position: Int, data: WCHelpQuestionBean) {
...
//    }  
    ...
    companion object {
        fun show(context: Context?) {
            IntentUtil.redirect(context, WCContactCustomerServiceActivity::class.java, false, null)
        }
    }
    ...
    var commonConfigs = ArrayList<WCCommonConfigBean>()

    //获取Vip通用配置  
    fun getCommonConfig(){
        GetHttpDataUtil.getCommonConfig(object : GetHttpDataUtil.OnSuccessAndFaultListener{
            override fun onSuccess(t: Any) {
                commonConfigs = t as ArrayList<WCCommonConfigBean>
                setData()
            }
    ...
    fun getIssuesList(){
        GetHttpDataUtil.getIssuesList(object : GetHttpDataUtil.OnSuccessAndFaultListener{
            override fun onSuccess(t: Any) {
                ...
                questionList.addAll(t as ArrayList<WCHelpQuestionBean>)
