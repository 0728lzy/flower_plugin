...
import com.weini.catdog.databinding.ActivityDetailBinding
import com.weini.catdog.ext.getBinding
import com.weini.catdog.ext.thrillClickListener


class WCDetailActivity : BaseActivity() {

    companion object {
        fun show(context: Context, index: Int) {
            context.startActivity(Intent(context, WCDetailActivity::class.java).apply { putExtra("index", index) })
        }
    }
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@WCDetailActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@WCDetailActivity,"信息",binding.feedContainerActivityDetail)
