...
import com.weini.catdog.databinding.ActivityIncomingCallBinding
...
class WCCallActivity : BaseActivity() {


    companion object {
        fun show(context: Context, index: Int) {
            context.startActivity(Intent(context, WCCallActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ivAnswerIncoming.thrillClickListener {
            PermissionUtils.tryToDoSomethingWithCheckPermissionAndCode(
                ...
                answer()
                com.weini.catdog.utils.VibrateTool.vibrateStop()
            }
        }
        binding.rlIncomingCall.isVisible = true
        binding.rlAnswerCall.isVisible = false
        com.weini.catdog.utils.VibrateTool.vibrateComplicated(this, longArrayOf(500L, 1000L), 0)
    }
    ...
    private fun playVideo() {
        ...
        val dataSourceFactory = DataSource.Factory { AssetDataSource(this@WCCallActivity) }
