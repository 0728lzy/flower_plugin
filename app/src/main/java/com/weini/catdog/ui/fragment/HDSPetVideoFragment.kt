...
import com.weini.catdog.databinding.FragmentPetVideoBinding
import com.weini.catdog.databinding.ItemPetVideoBinding
...
import com.weini.catdog.ui.activity.WCVideoActivity
            ...
            onBind {
                getBinding<ItemPetVideoBinding>().apply {
                    ...
                    root.thrillClickListener {
                        ...
                        WCVideoActivity.show(requireContext(), index)
                    }
                }
            }
        }
