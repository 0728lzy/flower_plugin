...
import com.weini.catdog.databinding.FragmentPetManagementBinding
import com.weini.catdog.event.SimpleEvent
import com.weini.catdog.model.Pet
import com.weini.catdog.ui.activity.WCPetBathActivity
import com.weini.catdog.ui.activity.WCPetNotesActivity
import com.weini.catdog.ui.activity.WCPetPhotosActivity
import com.weini.catdog.ui.adapter.PetAdapter
import com.weini.catdog.ui.dialog.AddPetDialog
...
class HDSPetManagementFragment : RootFragment(R.layout.fragment_pet_management) {
    ...
    private fun initViews() {
        ...
        binding.layoutPetAlbum.setOnClickListener {
            ...
            WCPetPhotosActivity.forward(requireContext())
        ...
        binding.layoutPetNotes.setOnClickListener {
            ...
            // 如果只有一只宠物，直接跳转到该宠物的相册
            WCPetNotesActivity.forward(requireContext())
        }
        ...
        binding.layoutBathRecord.setOnClickListener {
            ...
            // 如果只有一只宠物，直接跳转到该宠物的相册
            WCPetBathActivity.forward(requireContext())
        }
    }
    ...
    private fun showPetSelectionDialog() {
        ...
        XPopup.Builder(requireContext())
            .asBottomList("选择宠物", petNames) { position, text ->
                com.weini.catdog.ui.activity.WCPetPhotosActivity.forward(requireContext())
            }
            .show()
    }
