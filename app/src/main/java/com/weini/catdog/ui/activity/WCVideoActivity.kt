...
import com.weini.catdog.databinding.ActivityOverviewCallBinding
...
class WCVideoActivity : BaseActivity() {

    companion object {
        fun show(context: Context, index: Int) {
            context.startActivity(Intent(context, WCVideoActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@WCVideoActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@WCVideoActivity,"信息",binding.feedContainer)
    ...
    private fun goCall() {
        stopTime()
        reset()
        WCCallActivity.show(this, index)
    }
