...
import com.weini.catdog.databinding.FragmentAboutBinding
...
import com.weini.catdog.ui.activity.WCContactCustomerServiceActivity
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        privacyLinearLayout.thrillClickListener {
            WCWebViewActivity.forward(
                requireActivity() as com.weini.catdog.base.dj.BaseActivity,
        ...
        feedbackLinearLayout.thrillClickListener {
            WCContactCustomerServiceActivity.show(requireActivity() as com.weini.catdog.base.dj.BaseActivity)
        }
