...
import com.weini.catdog.databinding.ActivityPetPhotosBinding
import com.weini.catdog.model.Pet
import com.weini.catdog.model.PetPhoto
import com.weini.catdog.ui.adapter.PetPhotosAdapter
import com.weini.catdog.ui.dialog.UploadPhotoDialog
...
class WCPetPhotosActivity : BaseActivity() {
    ...
    companion object {
        fun forward(context: Context) {
            val intent = Intent(context, WCPetPhotosActivity::class.java)
    ...
    private fun initViews() {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@WCPetPhotosActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@WCPetPhotosActivity,"信息",binding.feedContainer)
    }
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvPhotos.apply {
            layoutManager = GridLayoutManager(this@WCPetPhotosActivity, 2)
    ...
    private fun showUploadPhotoDialog() {
        ...
        inputPopupView = XPopup.Builder(this@WCPetPhotosActivity)
