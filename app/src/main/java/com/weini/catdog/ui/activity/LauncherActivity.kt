...
import com.weini.catdog.csj.AdCPNoLimitUtils
import com.weini.catdog.csj.AdSPUtils
import com.weini.catdog.csj.AdSPTwoUtils
...
import com.weini.catdog.csj.lzy.EventCounterHelper
import com.weini.catdog.csj.lzy.LzyUtils
import com.weini.catdog.databinding.ActivityLauncherBinding
import com.weini.catdog.dialog.AgreementCancelDialog
import com.weini.catdog.dialog.AgreementDialog
import com.weini.catdog.dialog.DialogCallBack
import com.weini.catdog.event.DownTimeEvent
import com.weini.catdog.event.IpRiskEvent
import com.weini.catdog.event.dj.ActiveEvent
import com.weini.catdog.helper.dj.PushHelper
import com.weini.catdog.utils.dj.AntiRepeatClickUtils
import com.weini.catdog.utils.dj.CountDownTool
import com.weini.catdog.utils.dj.DeviceInfoUtil
import com.weini.catdog.utils.dj.GetHttpDataUtil
import com.weini.catdog.utils.dj.ICountDown
import com.weini.catdog.utils.dj.SharedPreferencesDelegate
...
//                }
    ...
    fun initKaiPing2() {
        ...
        if (AppConst.is_show_ad) {
            ...
            kpLoadIsSuccess = 0
            kpLoadIsSuccess2 = 0
            Log.d(TAG, "AdSPTwoUtils 加载开屏: ")
            AdSPTwoUtils.init(object : AdSPTwoUtils.GmSplashAdListener {
                override fun onLoadFinish() {
                    Log.d(
                        TAG,
                        "AdSPTwoUtils 展示开屏 kpLoadIsSuccess2:" + kpLoadIsSuccess2 + ",kpIsShow:" + kpIsShow
                    )
                    isShowAD = true
                    kpLoadIsSuccess = 1
                    EventCounterHelper.recordEvent()
                ...
                override fun onLoadFail() {
                    Log.d(TAG, "AdSPTwoUtils load 报错了 ")
                    kpLoadIsSuccess = 2
                    adHandler.postDelayed({
                        goMainActivity()
                    }, 8000)
                ...
                override fun onClose() {
                    ...
                    Log.d(
                        TAG,
                        "AdSPTwoUtils load 开屏结束 kpLoadIsSuccess2： " + kpLoadIsSuccess2
                    )
                    if (adHandler != null) {
                        Log.d(TAG, "AdSPTwoUtils adHandler 销毁动作 ")
                        adHandler.removeCallbacksAndMessages(null)
                    }
    ...
    fun showKaiPing() {
        ...
        Log.e(
            TAG,
            "showKaiPingAppConst.is_show_ad :" + AppConst.is_show_ad + ",UserInfoModel.getIsCheckFlag():" + UserInfoModel.getIsCheckFlag()
        )
        if (!UserInfoModel.getIsCheckFlag() || AppConst.is_show_ad) {
...
//                }, 1500)
    ...
    fun startCountDownTool() {
        ...
        countDownTool = object : CountDownTool(11L) {
...
//        }
        ...
        if ((UserInfoModel.getIsFirstTime() || UserInfoModel.getIsFirstNormal()) && TextUtils.isEmpty(
                UserInfoModel.getDjid()
            )
        ) {
