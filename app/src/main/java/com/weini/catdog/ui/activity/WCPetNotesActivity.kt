...
import com.weini.catdog.databinding.ActivityPetNotesBinding
import com.weini.catdog.model.Pet
import com.weini.catdog.model.PetNote
import com.weini.catdog.ui.adapter.PetNotesAdapter
import com.weini.catdog.ui.dialog.AddEditNoteDialog
import com.gyf.immersionbar.ImmersionBar
import com.lxj.xpopup.XPopup
import com.lxj.xpopup.core.BasePopupView


class WCPetNotesActivity : BaseActivity() {

    companion object {
        fun forward(context: Context) {
            val intent = Intent(context, WCPetNotesActivity::class.java)
    ...
    private fun initViews() {
        ...
        ZYMAllAdsUtils.showAdCpTurnTab(this@WCPetNotesActivity,"CP")
        ZYMAllAdsUtils.loadSimpleAll(this@WCPetNotesActivity,"信息",binding.feedContainer)
    }
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvNotes.apply {
            layoutManager = LinearLayoutManager(this@WCPetNotesActivity)
            ...
            onNoteActionListener = object : AddEditNoteDialog.OnNoteActionListener {
                override fun onNoteSaved(note: PetNote) {
                    ...
                    if (note.save()) {
                        ...
                        ZYMAllAdsUtils.showAdCpTurnTab(this@WCPetNotesActivity,"CP")
                        Toast.makeText(this@WCPetNotesActivity, message, Toast.LENGTH_SHORT).show()
                    } else {
                        Toast.makeText(this@WCPetNotesActivity, "保存失败", Toast.LENGTH_SHORT).show()
                    }
                }
            }
        )

        inputPopupView = XPopup.Builder(this@WCPetNotesActivity)
