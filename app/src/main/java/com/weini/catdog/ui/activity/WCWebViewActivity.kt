...
import com.weini.catdog.databinding.ActivitySimpleBrowserBinding
import com.weini.catdog.ext.dj.thrillClickListener
import com.weini.catdog.utils.dj.GetHttpDataUtil
import com.weini.catdog.utils.dj.UserInfoModel
import com.weini.catdog.widget.dj.NewWebView
import com.yl.adsdk.YlLib


class WCWebViewActivity : BaseActivity() {
    companion object {

        fun forward(context: Context, title: String, url: String) {
            context.startActivity(Intent(context, WCWebViewActivity::class.java).apply {
                putExtra("url", url)
