...
import com.weini.maogou.csj.lzy.LZYCPCounterHelper
import com.weini.maogou.csj.AdCPNoLimitUtils
import com.weini.maogou.csj.AdCPTwoUtils
import com.weini.maogou.csj.AdManagerHolder
import com.weini.maogou.csj.lzy.EventCounterHelper
import com.weini.maogou.db.RoomHelper
import com.weini.maogou.helper.dj.PushHelper
import com.weini.maogou.net.GsonConverter
import com.weini.maogou.ui.activity.WHLauncherActivity
import com.weini.maogou.utils.dj.CountdownTimeTask
import com.weini.maogou.utils.dj.GetHttpDataUtil
import com.weini.maogou.utils.dj.SPUtils
import com.weini.maogou.utils.dj.TimeUtil
import com.weini.maogou.utils.dj.TimerInitSDK
...
class APP : Application() {
    ...
    override fun onCreate() {
        ...
        NetConfig.initialize("", this) {
            ...
            setDebug(com.weini.maogou.BuildConfig.DEBUG)
            ...
            addInterceptor(LogRecordInterceptor(com.weini.maogou.BuildConfig.DEBUG))
        }
        DialogX.init(this)
    ...
    fun intLifecycleCallbacks() {
        ...
        registerActivityLifecycleCallbacks(object : ActivityLifecycleCallbacks {
            ...
            override fun onActivityStarted(activity: Activity) {
                if (AppConst.is_show_ad||activity is WHLauncherActivity) {
                    ...
                    if (appount == 1 && !isBackground) {
                        ...
                        if (!AppConst.isFront && isStarted &&AppConst.is_show_ad) {
                            ...
                            val intent = Intent(this@APP, WHLauncherActivity::class.java)
