...
import com.appcatdog.translations.databinding.FragmentIndex3Binding
import com.appcatdog.translations.entity.Index3Entity
...
import com.appcatdog.translations.ui.dialog.ResultDialog
...
class Index3Fragment : RootFragment(R.layout.fragment_index_3) {
    ...
    private var record: com.appcatdog.translations.utils.AudioRecordUtil? = null
        ...
        binding.btnRecord.thrillClickListener {
            PermissionUtils.tryToDoSomethingWithCheckPermissionAndCode(
                ...
                if (binding.lottie.isAnimating) {
                    ...
                    if (record == null) {
                        record = com.appcatdog.translations.utils.AudioRecordUtil()
