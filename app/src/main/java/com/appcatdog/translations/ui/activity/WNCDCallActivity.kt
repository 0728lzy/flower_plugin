...
import com.appcatdog.translations.databinding.ActivityIncomingCallBinding
import com.appcatdog.translations.ext.countDown
import com.appcatdog.translations.ext.thrillClickListener
import com.appcatdog.translations.utils.lzy.PermissionUtils
import java.util.Formatter
import java.util.TimerTask
import java.util.concurrent.ExecutionException


class WNCDCallActivity : BaseActivity() {


    companion object {
        fun show(context: Context, index: Int) {
            context.startActivity(Intent(context, WNCDCallActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ivAnswerIncoming.thrillClickListener {
            PermissionUtils.tryToDoSomethingWithCheckPermissionAndCode(
                ...
                answer()
                com.appcatdog.translations.utils.VibrateTool.vibrateStop()
            }
        }
        binding.rlIncomingCall.isVisible = true
        binding.rlAnswerCall.isVisible = false
        com.appcatdog.translations.utils.VibrateTool.vibrateComplicated(this, longArrayOf(500L, 1000L), 0)
    }
    ...
    private fun playVideo() {
        ...
        val dataSourceFactory = DataSource.Factory { AssetDataSource(this@WNCDCallActivity) }
