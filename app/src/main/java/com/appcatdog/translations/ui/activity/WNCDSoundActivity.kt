...
import com.appcatdog.translations.databinding.ActivitySoundDetailBinding
import com.appcatdog.translations.ext.dp2px
...
class WNCDSoundActivity : BaseActivity() {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        val item = if (isDog) {
            com.appcatdog.translations.AppConst.dogSoundList(this)[index]
        } else {
            com.appcatdog.translations.AppConst.catSoundList(this)[index]
        }
