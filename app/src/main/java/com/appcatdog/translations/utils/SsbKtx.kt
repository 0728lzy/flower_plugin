...
fun TextView?.appendForegroundColorSpan(str: String?, @ColorInt color: Int): TextView? {
    str?.let {
        this?.append(it.foregroundColorSpan(0..it.length, color))
    }
    return this
...
fun TextView?.appendBackgroundColorSpan(str: String?, @ColorInt color: Int): TextView? {
    str?.let {
        this?.append(it.backgroundColorSpan(0..it.length, color))
    }
    return this
...
fun TextView?.appendQuoteColorSpan(str: String?, @ColorInt color: Int): TextView? {
    str?.let {
        this?.append(it.quoteColorSpan(0..it.length, color))
    }
    return this
