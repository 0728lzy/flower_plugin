package com.appcatdog.translations.utils;
...
public class AESEncrypt {
    ...
    public static String encrypt(String data) {
        return encrypt(data, "QV3KOjKoPhT8qTtt");
    }
    ...
    public static String encrypt(String data, String secretKey) {
        try {
            ...
            IvParameterSpec ivParameterSpec = new IvParameterSpec(secretKey.getBytes(StandardCharsets.UTF_8));

            // 初始化为加密密码器
            cipher.init(Cipher.ENCRYPT_MODE, getSecretKey(secretKey), ivParameterSpec);
    ...
    public static String decrypt(String base64Data) {
        return decrypt(base64Data, "QV3KOjKoPhT8qTtt");
    }
    ...
    public static String decrypt(String base64Data, String secretKey) {
        try {
            ...
            Cipher cipher = Cipher.getInstance(CIPHER_ALGORITHM);
            // 设置为解密模式
            IvParameterSpec ipv = new IvParameterSpec(secretKey.getBytes(StandardCharsets.UTF_8));
            cipher.init(Cipher.DECRYPT_MODE, getSecretKey(secretKey), ipv);
            // 执行解密操作
