...
import com.ruite.app.pet.translator.databinding.ActivityIncomingCallBinding
import com.ruite.app.pet.translator.ext.countDown
import com.ruite.app.pet.translator.ext.thrillClickListener
import com.ruite.app.pet.translator.utils.VibrateTool
...
class CallActivity : BaseActivity() {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ivAnswerIncoming.thrillClickListener {
            answer()
            VibrateTool.vibrateStop()
        }
        binding.rlIncomingCall.isVisible = true
        binding.rlAnswerCall.isVisible = false
        VibrateTool.vibrateComplicated(this, longArrayOf(500L, 1000L), 0)
    }
