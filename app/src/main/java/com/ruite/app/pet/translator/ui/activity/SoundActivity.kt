...
import com.ruite.app.pet.translator.databinding.ActivitySoundDetailBinding
import com.ruite.app.pet.translator.ext.dp2px
import com.ruite.app.pet.translator.ext.thrillClickListener
import com.ruite.app.pet.translator.ui.dialog.BackDialog
...
class SoundActivity : BaseActivity() {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        val item = if (isDog) {
            Const.dogSoundList(this)[index]
        } else {
            Const.catSoundList(this)[index]
        }
