...
import com.ruite.app.pet.translator.databinding.ActivityMainBinding
import com.ruite.app.pet.translator.ext.thrillClickListener
import com.ruite.app.pet.translator.ui.fragment.Index1Fragment
import com.ruite.app.pet.translator.ui.fragment.Index2Fragment
import com.ruite.app.pet.translator.ui.fragment.Index3Fragment
import com.ruite.app.pet.translator.ui.fragment.Index4Fragment
import com.ruite.app.pet.translator.ui.fragment.Index5Fragment
import com.ruite.app.pet.translator.utils.LanguageUtils
import com.ruite.app.pet.translator.utils.ShareFileUtils
...
class MainActivity : BaseActivity() {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        binding.contentNav.llShareNow.thrillClickListener {
            ...
            val result = "${str1}\n${str2}\n${url}"
            ShareFileUtils.shareUrl(this, result)
        }
