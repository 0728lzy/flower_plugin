...
import com.ruiteapp.pettranslator.databinding.ActivityIncomingCallBinding
import com.ruiteapp.pettranslator.ext.countDown
import com.ruiteapp.pettranslator.ext.thrillClickListener
import com.ruiteapp.pettranslator.utils.lzy.PermissionUtils
import java.util.Formatter
import java.util.TimerTask
import java.util.concurrent.ExecutionException


class ZZCallActivity : BaseActivity() {


    companion object {
        fun show(context: Context, index: Int) {
            context.startActivity(Intent(context, ZZCallActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ivAnswerIncoming.thrillClickListener {
            PermissionUtils.tryToDoSomethingWithCheckPermissionAndCode(
                ...
                answer()
                com.ruiteapp.pettranslator.utils.VibrateTool.vibrateStop()
            }
        }
        binding.rlIncomingCall.isVisible = true
        binding.rlAnswerCall.isVisible = false
        com.ruiteapp.pettranslator.utils.VibrateTool.vibrateComplicated(this, longArrayOf(500L, 1000L), 0)
    }
    ...
    private fun playVideo() {
        ...
        val dataSourceFactory = DataSource.Factory { AssetDataSource(this@ZZCallActivity) }
