...
import com.ruiteapp.pettranslator.entity.Index3Entity
...
import com.ruiteapp.pettranslator.ui.dialog.ResultDialog
...
class ZZIndex3Fragment : RootFragment(R.layout.fragment_index_3) {

    var _binding: FragmentIndex3Binding? = null

    val binding get() = _binding!!

    private var record: com.ruiteapp.pettranslator.utils.AudioRecordUtil? = null
        ...
        binding.btnRecord.thrillClickListener {
            PermissionUtils.tryToDoSomethingWithCheckPermissionAndCode(
                ...
                if (binding.lottie.isAnimating) {
                    ...
                    if (record == null) {
                        record = com.ruiteapp.pettranslator.utils.AudioRecordUtil()
