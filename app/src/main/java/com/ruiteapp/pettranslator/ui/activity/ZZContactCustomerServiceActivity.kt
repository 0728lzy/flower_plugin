...
import com.ruiteapp.pettranslator.adapter.dj.RBHelpQuestionAdapter
import com.ruiteapp.pettranslator.adapter.dj.base.ItemClickListener
import com.ruiteapp.pettranslator.adapter.dj.utils.GridRec
...
import com.ruiteapp.pettranslator.utils.dj.IntentUtil
import com.lxj.xpopup.XPopup
import com.lxj.xpopup.impl.LoadingPopupView


@SuppressLint("NonConstantResourceId")
class ZZContactCustomerServiceActivity : BaseActivity(){




    private var questionList = ArrayList<ZZHelpQuestionBean>()
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        mAdapter.setItemClickListener(object : ItemClickListener<ZZHelpQuestionBean> {
            override fun click(position: Int, data: ZZHelpQuestionBean) {
...
//    }
    ...
    companion object {
        fun show(context: Context?) {
            IntentUtil.redirect(context, ZZContactCustomerServiceActivity::class.java, false, null)
        }
    }
    ...
    var commonConfigs = ArrayList<ZZCommonConfigBean>()

    //获取Vip通用配置
    fun getCommonConfig(){
        GetHttpDataUtil.getCommonConfig(object : GetHttpDataUtil.OnSuccessAndFaultListener{
            override fun onSuccess(t: Any) {
                commonConfigs = t as ArrayList<ZZCommonConfigBean>
                setData()
            }
    ...
    fun getIssuesList(){
        GetHttpDataUtil.getIssuesList(object : GetHttpDataUtil.OnSuccessAndFaultListener{
            override fun onSuccess(t: Any) {
                ...
                questionList.addAll(t as ArrayList<ZZHelpQuestionBean>)
