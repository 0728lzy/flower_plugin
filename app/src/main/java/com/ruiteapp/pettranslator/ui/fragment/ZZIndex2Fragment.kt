...
import com.ruiteapp.pettranslator.databinding.FragmentIndex4Binding
import com.ruiteapp.pettranslator.databinding.Item4Binding
import com.ruiteapp.pettranslator.entity.Index4Entity
import com.ruiteapp.pettranslator.ext.getBinding
import com.ruiteapp.pettranslator.ext.thrillClickListener
import com.ruiteapp.pettranslator.ui.activity.ZZDetailActivity
import com.ruiteapp.pettranslator.utils.lzy.LZYADSUtils
import com.tbuonomo.viewpagerdotsindicator.setBackgroundCompat


class ZZIndex2Fragment : RootFragment(R.layout.fragment_index_4) {
            ...
            onBind {
                getBinding<Item4Binding>().apply {
                    ...
                    root.thrillClickListener {
                        ...
                        ZZDetailActivity.show(requireContext(), index)
                    }
                }
            }
        }
