...
import com.ruiteapp.pettranslator.databinding.FragmentIndex5Binding
import com.ruiteapp.pettranslator.databinding.Item5Binding
...
import com.ruiteapp.pettranslator.ui.activity.ZZVideoActivity
...
class ZZIndex4Fragment : RootFragment(R.layout.fragment_index_5) {
            ...
            onBind {
                getBinding<Item5Binding>().apply {
                    ...
                    root.thrillClickListener {
                        ...
                        ZZVideoActivity.show(requireContext(), index)
                    }
                }
            }
        }
