...
import com.ruiteapp.pettranslator.databinding.ActivityAboutBinding
...
class ZZAboutActivity : BaseActivity() {

    companion object {
        fun forward(context: BaseActivity) {
            val intent = Intent(context, ZZAboutActivity::class.java)
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        mineLinearLayout.outlineProvider = object : ViewOutlineProvider() {
            override fun getOutline(view: View, outline: Outline?) {
                outline?.setRoundRect(
                    ...
                    view.width,
                    view.height,
                    ScreenUtils.dip2px(15, this@ZZAboutActivity).toFloat()
                )
            }
        }
        ...
        feedbackLinearLayout.thrillClickListener {
            ZZContactCustomerServiceActivity.show(this@ZZAboutActivity)
        }
    ...
    private fun showInputPasswordDialog() {
        ...
        val customPopup =
            QNInputPasswordDialogPopup(this@ZZAboutActivity)
        ...
        inputPopupView = XPopup.Builder(this@ZZAboutActivity)
