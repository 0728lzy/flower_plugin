...
import com.ruiteapp.pettranslator.databinding.ActivitySoundDetailBinding
import com.ruiteapp.pettranslator.ext.dp2px
...
class ZZSoundActivity : BaseActivity() {

    companion object {
        fun show(context: Context, isDog: Boolean, index: Int) {
            context.startActivity(Intent(context, ZZSoundActivity::class.java).apply {
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        lzyadsUtils=LZYADSUtils("SoundActivity",this@ZZSoundActivity)
        ...
        val item = if (isDog) {
            com.ruiteapp.pettranslator.AppConst.dogSoundList(this)[index]
        } else {
            com.ruiteapp.pettranslator.AppConst.catSoundList(this)[index]
        }
