...
import com.ruiteapp.pettranslator.databinding.ActivityDetailBinding
...
class ZZDetailActivity : BaseActivity() {

    companion object {
        fun show(context: Context, index: Int) {
            context.startActivity(Intent(context, ZZDetailActivity::class.java).apply { putExtra("index", index) })
        }
    }
