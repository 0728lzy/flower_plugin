...
import com.ruiteapp.pettranslator.databinding.ActivitySimpleBrowserBinding
import com.ruiteapp.pettranslator.ext.dj.thrillClickListener
import com.ruiteapp.pettranslator.utils.dj.GetHttpDataUtil
import com.ruiteapp.pettranslator.utils.dj.UserInfoModel
import com.ruiteapp.pettranslator.widget.dj.NewWebView
import com.yl.adsdk.YlLib


class ZZWebViewActivity : BaseActivity() {
    companion object {

        fun forward(context: Context, title: String, url: String) {
            context.startActivity(Intent(context, ZZWebViewActivity::class.java).apply {
                putExtra("url", url)
