...
import com.ruiteapp.pettranslator.databinding.ActivityPermissionBinding
import com.ruiteapp.pettranslator.ext.thrillClickListener

class ZZPermissionActivity : BaseActivity() {

    companion object {
        fun forward(context: Context) {
            context.startActivity(Intent(context, ZZPermissionActivity::class.java))
        }
    }
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnContinue2.thrillClickListener {
            ...
            ZZMainActivity.forward(this@ZZPermissionActivity)
        }
    }
