...
import com.ruiteapp.pettranslator.databinding.FragmentIndex2Binding
...
import com.ruiteapp.pettranslator.ui.activity.ZZMainActivity
import com.ruiteapp.pettranslator.ui.activity.ZZContactCustomerServiceActivity
import com.ruiteapp.pettranslator.ui.activity.ZZWebViewActivity
...
import com.ruiteapp.pettranslator.widget.popup.dj.QNInputPasswordDialogPopup
...
class ZZIndex5Fragment : RootFragment(R.layout.fragment_index_2) {

    var _binding: FragmentIndex2Binding? = null
    private lateinit var lzyadsUtils: LZYADSUtils
    private lateinit var myActivity: ZZMainActivity
    ...
    override fun initView(view: View, savedInstanceState: Bundle?) {
        ...
        myActivity = requireActivity() as ZZMainActivity
        ...
        feedbackLinearLayout.thrillClickListener {
            ZZContactCustomerServiceActivity.show(requireContext())
        }
