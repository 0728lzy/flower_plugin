...
import com.ruiteapp.pettranslator.ui.activity.ZZLauncherActivity
import com.ruiteapp.pettranslator.utils.dj.CountdownTimeTask
import com.ruiteapp.pettranslator.utils.dj.GetHttpDataUtil
import com.ruiteapp.pettranslator.utils.dj.SPUtils
import com.ruiteapp.pettranslator.utils.dj.TimeUtil
import com.ruiteapp.pettranslator.utils.dj.TimerInitSDK
...
class APP : Application() {
    ...
    override fun onCreate() {
        ...
        NetConfig.initialize("", this) {
            ...
            setDebug(com.ruiteapp.pettranslator.BuildConfig.DEBUG)
            ...
            addInterceptor(LogRecordInterceptor(com.ruiteapp.pettranslator.BuildConfig.DEBUG))
        }
        DialogX.init(this)
    ...
    fun intLifecycleCallbacks() {
        ...
        registerActivityLifecycleCallbacks(object : ActivityLifecycleCallbacks {
            ...
            override fun onActivityStarted(activity: Activity) {
                if (AppConst.is_show_ad||activity is ZZLauncherActivity) {
                    ...
                    if (appount == 1 && !isBackground) {
                        ...
                        if (!AppConst.isFront && isStarted &&AppConst.is_show_ad) {
                            ...
                            val intent = Intent(this@APP, ZZLauncherActivity::class.java)
