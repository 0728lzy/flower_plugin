...
//开通会员
public class ZZOpenMemberBean implements Serializable {
    ...
    private ZZOpenMemberBean renewGoodsVO;


    public ZZOpenMemberBean getRenewGoodsVO() {
        return renewGoodsVO;
    }

    public void setRenewGoodsVO(ZZOpenMemberBean renewGoodsVO) {
